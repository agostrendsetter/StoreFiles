        ...
        callMainnetNetwork('',addr, contractAddr, value, 3)
            .then(function (data) {
                if (data.error) {
                    ...
                    getUSDPrice(data.symbol, 'USD')
                        .then(function (usdPrice) {                          
                            generateTokenInfo(data, value, usdPrice, contractAddr);
                        });                   
                }
...
function generateTokenInfo(data, network, usdPrice, contractAddr) {
    ...
    try {
        ...
        if (data.result == null) {
            ...
            var value = usdPrice.USD ? new BigNumber(balance * usdPrice.USD) + ' USD  <font size="1">(@' + usdPrice.USD + '/USD)</font>' : '0.00000000';
